...
@Component({
  selector: 'app-staff-all-list',
  templateUrl: './staff-all-list.component.html',
  styleUrls: ['./staff-all-list.component.css']
})
export class StaffAllListComponent implements OnInit {
