...
@Component({
  selector: 'app-staff-inactive-list',
  templateUrl: './staff-inactive-list.component.html',
  styleUrls: ['./staff-inactive-list.component.css']
})
export class StaffInactiveListComponent implements OnInit {
